...
impl Component for Root {
    ...
    async fn node(&mut self) -> Node {
        path([22, 234, 0], [
            bezier([0.15, 0.1], [0.9, 0.1], [0.2, 0.05], [0.8, 0.15]),
            bezier([0.9, 0.1], [0.95, 0.9], [0.75, 0.15], [0.95, 0.85]),
            bezier([0.95, 0.9], [0.1, 0.8], [0.9, 0.9], [0.1, 0.9]),
            bezier([0.1, 0.8], [0.15, 0.1], [0.05, 0.85], [0.05, 0.05])
        ])
